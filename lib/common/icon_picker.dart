...
class IconPicker extends StatefulWidget {
  final void Function(IconData) onIconSelect;
  const IconPicker({super.key, required this.onIconSelect});
        ...
        onChanged: (value) {
          ...
          if (value.isNotEmpty) {
            for (var i = 0; i < iconKeys.length; i++) {
              if (iconKeys.elementAt(i).contains(value)) {
                result.add(iconKeys.elementAt(i));
              }
            }
            setState(() {
              iconKeys = result;
          ...
          itemBuilder: (context, index) {
            return ShadCard(
              ...
              child: Center(
                child: IconButton(
                  onPressed: () {
                    if (icons[iconKeys[index]] != null) {
                      widget.onIconSelect(icons[iconKeys[index]]!);
                    }
                  },
                  icon: Icon(icons[iconKeys[index]]),
                ),
              ),
            );
          },
